package com.Project.doudizhu.src.com.itheima.game;


import com.Project.doudizhu.src.com.itheima.domain.User;
import com.Project.doudizhu.src.com.itheima.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    //Java-Study-01\src\com\Project\Test\doudizhu\image\login\background.png
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("Java-Study-01\\src\\com\\Project\\doudizhu\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("Java-Study-01\\src\\com\\Project\\doudizhu\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("Java-Study-01\\src\\com\\Project\\doudizhu\\image\\login\\background.png"));
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("Java-Study-01\\src\\com\\Project\\doudizhu\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("Java-Study-01\\src\\com\\Project\\doudizhu\\image\\login\\注册按下.png"));
        }
    }
